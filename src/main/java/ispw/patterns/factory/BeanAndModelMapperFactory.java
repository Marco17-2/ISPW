...
public class BeanAndModelMapperFactory {
    ...
    //Converte un Bean in un Model. Prende come parametri il ispw.bean da convertire e la classe del ispw.bean.
    ...
    //Converte un Model in un Bean. Il metodo prende come parametri il ispw.model da convertire e la sua classe
    @SuppressWarnings("unchecked")
